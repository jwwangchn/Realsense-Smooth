...
int main()
{
	...
	Mat i_before(IMAGE_WIDTH, IMAGE_HEIGHT, CV_8UC4);				// 为了显示方便
	Mat i_after(IMAGE_WIDTH, IMAGE_HEIGHT, CV_8UC4);				// 为了显示方便
	Mat i_result(IMAGE_WIDTH, IMAGE_HEIGHT, CV_16UC1);				// 滤波结果
